...
-- Copia y pega este script en el editor SQL de Supabase Dashboard
...
DROP TRIGGER IF EXISTS update_paypal_subscriptions_updated_at ON paypal_subscriptions;
CREATE TRIGGER update_paypal_subscriptions_updated_at 
  BEFORE UPDATE ON paypal_subscriptions 
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_paypal_payments_updated_at ON paypal_payments;
